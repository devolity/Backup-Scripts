...
rsync -avz -e "ssh -i /home/script/ns3068517-111.139.pem -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" root@46.105.111.139:/var/www/html/media/ $backup_path/Fablaze-Media-2019/
