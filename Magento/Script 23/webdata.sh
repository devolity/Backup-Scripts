...
rsync -avz -e "ssh -i /home/script/ns3068517-111.139.pem -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null" --exclude media root@46.105.111.139:/var/www/html/ $backup_path/Fablaze-$date/
